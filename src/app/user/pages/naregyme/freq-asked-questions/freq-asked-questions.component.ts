  ...
  faqs = [
    {
      ...
      answer: 'Сначала необходимо пройти образовательный курс, а затем, по решению остальных членов клуба, можно остаться в клубе.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Да, отдельные курсы доступны с доступом в личный кабинет, но без инструментов клуба.'
    }
  ];
